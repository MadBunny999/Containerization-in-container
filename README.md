...
> ***Почему***: <br>
    ...
    &cross; Использовать переменные безопаснее - Докерфайл могут увидеть все и кто-то может украсть пароли, а переменные окружения обычно хранятся в секретах  и доступны лишь избранным. <br>
...
> ***Почему***: <br>
    ...
    &check; Это ускоряет сборку и делает докерфайл легче (преимущества кэширования)  <br>
